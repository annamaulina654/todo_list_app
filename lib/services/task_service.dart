...
//   // Read (Mengambil semua task)
//   static Future<List<Task>> fetchTasks() async {
//     final url = Uri.parse('$baseUrl.json');
//     try {
//       final response = await http.get(url);
//       if (response.statusCode == 200) {
//         // Jika tidak ada data, Firebase mengembalikan 'null'
...
//           value['id'] = entry.key; // Menyisipkan ID dari Firebase ke dalam data task
...
//   // Update (Mengubah data task, termasuk status isCompleted)
